    ...
    return (
      <Center padding={PAD_MD}>
        <VStack spacing={PAD_MD} width={["90%", "70%", "70%", "50%"]} fontSize="xl" alignItems="start">
          <Center width="100%"><Image src={process.env.PUBLIC_URL + '/logo192.png'} /></Center>
          ...
          <Text>Include the link to your certification in your bio and share <i>ShoeMe</i> with all your carbon-based friends and loved ones so they too can become fully realized digital person!</Text>
          <Center width="100%">
            <Link
              color="teal.500"
              href={CONTRACT_URL}
